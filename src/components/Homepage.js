          ...
          <section className="hero">
            <section className="hero-text-area">
              ...
              <p>
                ...
                <br /> the tools you need to boost productivity
              </p>
          ...
          <section className="hero-first-floor-text">
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  Prevent accidents and exonerate drivers with the most
                  accurate, fastest AI dash cam. Reduce insurance costs by
                  improving unsafe driving habits through automated coaching.
                </p>
              </section>
            </section>
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  Real-time visibility into the location, utilization, and
                  health of vehicles, equipment, and assets.
                </p>
              </section>
            </section>
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  ...
                  maintenance. Create thorough inspection records for vehicles
                  and assets. Maintain and access records electronically.
                </p>
              </section>
            </section>
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  ...
                  cloud-based dispatch management. Built on Motive’s
                  high-powered tracking solution. Dispatch your fleet with
                  confidence.
                </p>
              </section>
            </section>
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  ...
                  AI-powered insights and fleet fuel management. See your
                  fleet’s objective fuel consumption and trends.
                </p>
              </section>
            </section>
            ...
            <section className="products">
              ...
              <section className="product-listing-container">
                ...
                <p className="product-listing-text">
                  ...
                  smartest dual-facing camera on the market. AutoMate provides
                  the tools you need to keep your drivers on top of their game.
                </p>
              </section>
            </section>
